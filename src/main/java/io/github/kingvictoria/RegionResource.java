...
public enum RegionResource {
	WOOD(new ItemStack(Material.OAK_LOG)), STONE(new ItemStack(Material.SMOOTH_STONE)),
	IRON(new ItemStack(Material.IRON_INGOT)), WHEAT(new ItemStack(Material.WHEAT));
